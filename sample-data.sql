...
select * from Order1 INNER JOIN Customer
on Order1.customerid=customer.id

---2

select OrderItem.quantity,product.productName,product.UnitPrice from product INNER JOIN OrderItem
ON product.Id=OrderItem.ProductId

---3

select Customer.FirstName,Customer.lastName,Order1.TotalAmount from Customer Inner Join Order1
ON Customer.Id=Order1.CustomerId

--4

select TotalAmount,FirstName,LastName from Order1 right join Customer 
on Order1.customerId=Customer.id
where TotalAmount is null

---5

select * from Customer INNER JOIN Supplier
